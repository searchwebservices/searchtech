          ...
          <div className="container relative">
            ...
            >
              ...
              <p className="text-xl text-[var(--st-text-muted)] mb-8 max-w-2xl mx-auto">
                Transform your property management business into a complete PropTech company. Increase clients, satisfaction, and valuation almost instantly.
              </p>

              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-xl bg-[var(--st-surface)] border border-[var(--st-border)]">
                <TrendingUp className="w-4 h-4 text-green-500" />
                <span className="text-sm">From Property Manager to PropTech Company</span>
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[var(--st-surface)]">
          <div className="container">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-12">Why Experience OS?</h2>
                ...
                {[
                  {
                    ...
                    value: "+40%",
                    label: "More Clients",
                    description: "Property portals that convert better",
                  },
                  {
                    icon: Star,
                    value: "4.9★",
                    label: "Satisfaction",
                    description: "World-class guest experience",
                  },
                  {
                    icon: TrendingUp,
                    value: "3x",
                    label: "Valuation",
                    description: "From operator to tech company",
                  },
                ].map((stat, index) => (
                  <motion.div
                    key={index}
                ...
                {[
                  {
                    ...
                    description: "Unified dashboard for all your properties with real-time metrics.",
                  },
                  {
                    icon: Star,
                    title: "Guest Experience",
                    description: "Automated communication, digital guides, and virtual concierge.",
                  },
                  {
                    icon: BarChart3,
                    title: "Advanced Analytics",
                    description: "ROI per property, pricing analysis, and occupancy prediction.",
                  },
                  {
                    icon: TrendingUp,
                    title: "Revenue Optimization",
                    description: "AI that dynamically adjusts prices based on demand and competition.",
                  },
                  {
                    icon: Users,
                    title: "Owner Portal",
                    description: "Each owner sees reports and metrics for their properties.",
                  },
                  {
                    icon: Sparkles,
                    title: "AI Assistant",
                    description: "Answers guest questions and suggests improvements based on reviews.",
                  },
                ].map((feature, index) => (
                  <motion.div
                    key={index}
          ...
          <div className="container">
            <div className="max-w-2xl mx-auto text-center mb-12">
              ...
              <p className="text-[var(--st-text-muted)]">
                Experience OS is in active development. Join the waitlist for early access and early adopter pricing.
              </p>
            </div>
            <ProductWaitlistForm productName="Experience OS" locale="en" />
          </div>
        </section>
      </main>
