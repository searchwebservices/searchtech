  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
          ...
          <div className="container relative">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--st-primary)]/10 border border-[var(--st-primary)]/20 mb-6">
                ...
                <span className="text-sm font-medium text-[var(--st-primary)]">Manufacturing & Quality</span>
              </div>
              ...
              <p className="text-xl text-[var(--st-text-muted)] mb-8 max-w-2xl mx-auto">
                Traceability and quality control system for batch production and artisanal manufacturing.
              </p>
              ...
              <div className="mb-12">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  <span className="px-4 py-2 rounded-lg bg-[var(--st-surface)] border border-[var(--st-border)] text-sm">
                    Golden Sands <span className="text-[var(--st-text-muted)]">(Client)</span>
                  </span>
                  <span className="px-4 py-2 rounded-lg bg-[var(--st-surface)] border border-[var(--st-border)] text-sm">
                    Simbiotica MX
                  </span>
        ...
        <section className="py-20 bg-[var(--st-surface)]">
          <div className="container">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-12">Complete Production Control</h2>
                ...
                {[
                  {
                    ...
                    description: "System enforces completion of each safety step before production advances.",
                  },
                  {
                    icon: FlaskConical,
                    title: "Batch Traceability",
                    description: "Track every batch from raw materials to finished product with complete traceability.",
                  },
                  {
                    icon: Shield,
                    title: "Regulatory Compliance",
                    description: "Automatic reports for COFEPRIS and export regulations compliance.",
                  },
                  {
                    icon: BarChart3,
                    title: "Production Analytics",
                    description: "Identify bottlenecks, optimize timing, and reduce waste.",
                  },
                  {
                    icon: FileText,
                    title: "Automatic Documentation",
                    description: "Generate quality certificates, data sheets, and reports with one click.",
                  },
                  {
                    icon: Check,
                    title: "pH & Metrics Control",
                    description: "Real-time monitoring of critical variables with automatic alerts.",
                  },
                ].map((feature, index) => (
                  <motion.div
                    key={index}
          ...
          <div className="container">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-[var(--st-text-muted)] mb-8">
                Transparent pricing for artisanal manufacturing
              </p>

              <div className="p-8 rounded-2xl bg-[var(--st-surface)] border border-[var(--st-border)]">
                <div className="mb-6">
                  <div className="text-sm text-[var(--st-text-muted)] mb-2">Initial Build</div>
                ...
                <ul className="space-y-3 text-left mb-8">
                  {[
                    ...
                    "Custom checklists and validations",
        ...
        <section className="py-20 bg-[var(--st-surface)]">
          <div className="container">
            <ProductWaitlistForm productName="BatchCraft OS" locale="en" />
          </div>
        </section>
      </main>
      ...
      <footer className="py-8 border-t border-[var(--st-border)]">
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <Link href="/en" className="flex items-center gap-2">
              <Search className="w-5 h-5 text-[var(--st-primary)]" strokeWidth={1.5} style={{ transform: 'rotate(90deg)' }} />
              <span className="font-logo tracking-widths text-sm">SEARCH</span>
            </Link>
