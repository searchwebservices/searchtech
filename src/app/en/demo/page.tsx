        ...
        <div className="container">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Schedule Your{" "}
              <span className="st-gradient-text">Free Consultation</span>
            </h1>
            <p className="text-lg text-[var(--st-text-secondary)] max-w-2xl mx-auto">
              Book 30 minutes with our team to discuss how we can transform
              your business operations in Los Cabos.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-[var(--st-text-muted)]">
                We're available to assist you by email or phone.
              </p>
            </div>
            ...
            <div className="mt-6 flex items-center justify-center gap-2 text-sm text-[var(--st-text-muted)]">
              ...
              <span>Los Cabos, Baja California Sur, Mexico</span>
            </div>
          </div>
        </div>
      </main>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-sm text-[var(--st-text-muted)]">
              © {new Date().getFullYear()} Search | Operating Systems. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
