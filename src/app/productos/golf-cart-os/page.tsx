...
export default function GolfCartOSPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
          ...
          <div className="container relative">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--st-primary)]/10 border border-[var(--st-primary)]/20 mb-6">
                ...
                <span className="text-sm font-medium text-[var(--st-primary)]">Rentas de Vehículos</span>
              </div>
              ...
              <p className="text-xl text-[var(--st-text-muted)] mb-8 max-w-2xl mx-auto">
                El sistema operativo completo para negocios de renta de golf carts, UTVs y vehículos recreativos en Los Cabos.
              </p>
              ...
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-xl bg-[var(--st-surface)] border border-[var(--st-border)]">
                <span className="text-xs text-[var(--st-text-muted)]">Socio Estratégico</span>
                ...
                {[
                  {
                    ...
                    description: "Control total de tu inventario de vehículos, ubicaciones, y estado en tiempo real.",
                  },
                  {
                    icon: Wrench,
                    title: "Mantenimiento Predictivo",
                    description: "AI que predice cuándo cada unidad necesita servicio antes de que falle.",
                  },
                  {
                    icon: Calendar,
                    title: "Reservaciones Automáticas",
                    description: "Sistema de reservas 24/7 con confirmaciones por WhatsApp y email.",
                  },
                  {
                    icon: BarChart3,
                    title: "Analytics por Unidad",
                    description: "Conoce la rentabilidad exacta de cada vehículo en tu flota.",
                  },
                  {
                    icon: Clock,
                    title: "Historial Completo",
                    description: "Trazabilidad total: cada renta, cada servicio, cada cliente.",
                  },
                  {
                    icon: Users,
                    title: "Gestión de Clientes",
                    description: "CRM integrado con documentos, contratos y programa de lealtad.",
                  },
                ].map((feature, index) => (
                  <motion.div
                    key={index}
        ...
        <section className="py-20">
          <div className="container">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-4">Resultados Reales</h2>
              <p className="text-center text-[var(--st-text-muted)] mb-12">
                Lo que logran nuestros socios con Golf Cart OS
              </p>

              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  { value: "0", label: "Dobles Reservaciones", suffix: "" },
                  { value: "-83%", label: "Tiempo Administrativo", suffix: "" },
                  { value: "+28%", label: "Ingresos", suffix: "" },
                  { value: "4.8★", label: "Satisfacción Cliente", suffix: "" },
                ].map((stat, index) => (
                  <motion.div
                    key={index}
              ...
              <div className="p-8 rounded-2xl bg-background border border-[var(--st-border)]">
                ...
                <ul className="space-y-3 text-left mb-8">
                  {[
                    ...
                    "AI integrada con tu data",
                    "Soporte 24/7 local en Cabo",
        ...
        <section className="py-20">
          <div className="container">
            <ProductWaitlistForm productName="Golf Cart OS" locale="es" />
          </div>
        </section>
      </main>
