...
const content = {
  es: {
    ...
    principles: [
      ...
      { title: "Arquitectura Escalable", description: "Sistemas diseñados para crecer con tu negocio" },
    ...
    buildingTitle: "Tu Sistema es como un",
    buildingHighlight: "Edificio",
    buildingSubtitle: "Un modelo transparente: pagas por la construcción y por el mantenimiento continuo.",
    construction: {
      badge: "Pago Inicial",
      title: "Construcción",
      description: "Cubre el diseño, codificación y entrega de tu sistema operativo base personalizado. Preferimos empezar más pequeño y fundamental para conocerte mejor, luego construimos modularmente, flujo por flujo.",
