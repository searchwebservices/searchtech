...
const content = {
  es: {
    ...
    headline: ["No Somos Diseñadores de Webs,", "Somos", "Arquitectos de Sistemas Operativos."],
    subtitle: "Construimos sistemas operativos personalizados con la última tecnología para negocios en Los Cabos y Baja California Sur.",
    principles: [
      { title: "Custom OS", description: "Sistemas operativos a la medida, nunca plantillas genéricas" },
      { title: "Arquitectura Escalable", description: "Tu sistema operativo crece con tu negocio" },
      { title: "Seguridad Integrada", description: "Protección de datos desde el primer día" },
      { title: "Rendimiento Óptimo", description: "Sistemas operativos rápidos y responsivos" },
    ],
    marketComparison: {
    ...
    buildingTitle: "Tu Sistema Operativo es como un",
    buildingHighlight: "Edificio",
    buildingSubtitle: "Un modelo transparente: pagas por la construcción de tu custom OS y por el mantenimiento continuo.",
    construction: {
      badge: "Pago Inicial",
      title: "Construcción del OS",
      description: "Cubre el diseño, codificación y entrega de tu sistema operativo personalizado. Preferimos empezar más pequeño y fundamental para conocerte mejor, luego construimos tu custom OS modularmente, flujo por flujo.",
  ...
  en: {
    ...
    headline: ["We're Not Web Designers,", "We're", "Operating System Architects."],
    subtitle: "We build custom operating systems with the latest technology for businesses in Los Cabos and Baja California Sur.",
    principles: [
      { title: "Custom OS", description: "Custom operating systems, never generic templates" },
      { title: "Scalable Architecture", description: "Your operating system grows with your business" },
      { title: "Built-in Security", description: "Data protection from day one" },
      { title: "Optimal Performance", description: "Fast and responsive operating systems" },
    ],
    marketComparison: {
    ...
    buildingTitle: "Your Operating System is like a",
    buildingHighlight: "Building",
    buildingSubtitle: "A transparent model: you pay for custom OS construction and ongoing maintenance.",
    construction: {
      badge: "Initial Payment",
      title: "OS Construction",
      description: "Covers the design, coding, and delivery of your custom operating system. We prefer starting smaller and more fundamental to get to know you better, then we build out your custom OS modularly, workflow by workflow.",
