...
const content = {
  es: {
    badge: "Arquitectos de Software en Los Cabos",
    headline: ["LA INFRAESTRUCTURA", "DIGITAL QUE CABO", "SE MERECE."],
    subheadline: "Deje de operar con hojas de cálculo. Diseñamos, construimos y mantenemos",
    highlight: "sistemas operativos inteligentes",
    subheadlineEnd: "y exclusivos para su negocio en Los Cabos.",
    ctaPrimary: "Hable con un Arquitecto de Software",
    ...
    dashboard: {
      ...
      aiTitle: "Asistente Search Tech",
      aiMessage: '"Las 3 unidades con mayor margen son: Golf Cart #12 (42%), Golf Cart #7 (38%), y UTV #3 (35%). ¿Quieres que analice su rotación?"',
      status: "En línea",
      order: "Nuevo pedido",
    },
  },
  en: {
    badge: "Software Architects in Los Cabos",
    headline: ["THE DIGITAL", "INFRASTRUCTURE CABO", "DESERVES."],
    subheadline: "Stop running your business on spreadsheets. We design, build, and maintain",
    highlight: "intelligent operating systems",
    subheadlineEnd: "exclusively for your business in Los Cabos.",
      ...
      <div className="container relative z-10">
        ...
        >
          <Button
            asChild
            size="lg"
            className="h-14 px-8 text-base font-semibold bg-[var(--st-primary)] hover:bg-[var(--st-primary-light)] rounded-full group transition-all duration-300"
          >
