...
const content = {
  es: {
    ...
    storyP2: "Decidimos cambiar eso. Hoy, Search Technologies es el brazo tecnológico que Los Cabos necesitaba.",
    ...
    ctaHeadline: "Transforme su Operación.",
    ctaSubhead: "Agende su",
  ...
  en: {
    ...
    storyP2: "We decided to change that. Today, Search Technologies is the tech arm that Los Cabos needed.",
            ...
            <div className="relative bg-[var(--st-surface)] rounded-3xl border border-[var(--st-primary)]/30 p-8 md:p-12 text-center overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <Button
                  asChild
                  size="lg"
                  className="h-16 px-10 text-lg font-semibold bg-[var(--st-primary)] hover:bg-[var(--st-primary-light)] rounded-full group transition-all duration-300 shadow-lg shadow-[var(--st-primary)]/20"
                >
